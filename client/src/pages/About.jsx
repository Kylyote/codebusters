const About = () => {
  return (
    <div>
      <h1>Who We Are</h1>
      <p> Code Buster is more than just a web development company. We're a comprehensive platform that caters to all your web development needs, providing a one-stop solution for everything you need in the digital realm.</p>
      <h2>Hardware Shopping</h2>
      <p> We understand that not everyone is a tech expert, and sometimes, you might need a little help when it comes to hardware shopping. That's where we come in. With Code Buster, you can easily browse through our extensive selection of hardware and have everything you need delivered right to your doorstep. We offer a wide range of products, from laptops and desktops to peripherals and more, all at competitive prices.</p>
