...
const Services = () => {
  return (
      <div className="container">
          <h1 className="text-center" style={{fontSize: '70px'}}><strong>Services Offered</strong></h1>
          <br></br>
          <div className="row">
              <div  style={{backgroundColor:"red"}}className="col-md-6">
                 <h2><strong>Webdevlopment Tutoring</strong></h2>
                 <p>Our tutors provide personalized web development tutoring that will guide you through the process of creating a website. Our tutors have extensive experience in various web development languages and frameworks, and they will help you understand and implement best practices in your code. Whether you're a beginner or an experienced developer looking to enhance your skills, our tutoring service is designed to cater to your needs. With our expert guidance, you can overcome any hurdles and enhance your web development skills.</p>
                 <p><Link to="/search"><img className='glow-on-hover img-fluid' src={webDevTutoring} alt="Web Development Tutoring" /></Link></p>
              </div>
              <div style={{backgroundColor:"lightblue"}} className="col-md-6">
                 <h2><strong>Code Review</strong></h2>
                 <p>Our code review service is designed to help you identify and rectify any issues in your code. Our review specialist excel in providing professional reviews that ensure your code is clean, efficient, and ready for deployment. Whether you're struggling with a bug or need a professional review of a completed project, our code review specialists can help. Our team of experienced developers will provide detailed feedback and suggestions to improve your code, ensuring that it meets the highest standards of quality and performance.</p>
