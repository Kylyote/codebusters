...
const Services = () => {
 ...
 <div style={{backgroundColor:"gray"}} className="col-md-6 text-zoom glow-on-hover">
              ...
              <div style={{backgroundColor:"lightblue"}} className="col-md-6 text-zoom glow-on-hover">
                ...
                <Link to={{ pathname: "/search", state: {services:"Code Review"}}}>
                <p><img className='img-fluid' src={codeReview} alt="Code Review" /></p>
                </Link>
             </div>
         </div>
         
         <div className="row">
             <div style={{backgroundColor:"green"}} className="col-md-6 text-zoom glow-on-hover">
                ...
                <p><img className='img-fluid' src={websiteBuilding} alt="Website Building" /></p>
                </Link>
             </div>
             <div style={{backgroundColor:"orange"}} className="col-md-6 text-zoom glow-on-hover">
                ...
                <Link to="/resume">
                <p><img className='img-fluid' src={resumeBuilding} alt="Resume Building" /></p>
                </Link>
             </div>
         </div>
     </div>
